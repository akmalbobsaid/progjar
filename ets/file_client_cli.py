...
def stress_main(client_pools, server_pools):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--client-pool', type=int, default=1, help="Ukuran client pool")
    parser.add_argument('--server-pool', type=int, default=1, help="Ukuran server pool")
    ...
    if args.manual:
        ...
        stress_main(args.client_pool, args.server_pool)
